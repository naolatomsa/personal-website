...
const MyProjects = () => {
  return (
    <div className="mx-auto md:h-screen md:py-10 py-5  h-full flex gap-10 flex-col items-center ">
      ...
      <div className="md:flex grid grid-cols-2 gap-5 w-3/4 md:gap-3 justify-center">
        <button className="cursor-pointer hover:dark:bg-orange-700 active:dark:bg-orange-700 focus:dark:bg-orange-700 active:text-white focus:text-white hover:text-white font-semibold bg-gray-200 text-black px-4 py-1 rounded-md">
          All
        </button>
        <button className="cursor-pointer hover:dark:bg-orange-700 active:dark:bg-orange-700 focus:dark:bg-orange-700 active:text-white focus:text-white hover:text-white font-semibold bg-gray-200 text-black px-4 py-1 rounded-md">
          Website
      ...
      <div className="md:flex w-[90%] grid  justify-center gap-10 ">
        <div className="md:w-1/4 grid gap-2">
          ...
          <h1 className="dark:text-orange-700 font-bold text-xs">Website</h1>
          <h1 className="text-white text-xl">Menas Cyber Solution</h1>
          <p className="text-gray-200 text-[13px]">
            Passionate Full- Stack developer with a keen interest in software
            development and machine learning. Known for my enthusiasm and energy
            at work.
          </p>
          <a className="text-xs text-blue-700 underline">Go to the site</a>
        </div>
        <div className="md:w-1/4 grid gap-2">
          <img src={menas} alt="mypic" />
          <h1 className="dark:text-orange-700 font-bold text-xs">Website</h1>
