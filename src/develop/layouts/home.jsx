  ...
  return (
    <div className="md:flex font-sans grid md:gap-0  md:mt-14 mt-40 gap-10 md:justify-center md:mx-auto md:w-3/4  md:items-center place-content-center place-items-center md:h-screen">
      ...
      <div className="md:w-3/4 md:text-start text-center w-full grid md:gap-5 gap-3">
        <div>
          <h1 className="text-white text-2xl font-bold libertinus-math-regular">
            Hello, I am
          </h1>
        ...
        <div className="grid gap-1">
          <h1 className="text-white text-6xl font-bold libertinus-math-regular">
            Software
          </h1>
          <h1 className="text-white text-6xl md:ml-10 font-bold libertinus-math-regular">
            Developer
          </h1>
        </div>
        <div className="grid gap-3 md:place-items-start place-items-center">
          <h1 className="libertinus-math-regular md:text-[20px] text-[18px] leading-7 font-bold text-white md:w-full text-balance w-[95%]">
